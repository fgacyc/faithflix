  ...
  return (
    <>
      {genre_id ? (
        <div
          className={
            "z-10 ml-[50px] top-[75px]  h-[50px] flex flex-row justify-between items-center absolute"
          }
        >
        ...
        <div
          className={
            "z-10 ml-[50px] top-[75px]  w-[300px] h-[50px] flex flex-row justify-between items-center absolute"
          }
        >
