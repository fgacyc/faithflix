...
export default function Profile() {
  ...
  const [language, setLanguage] = useUserStore((state) => [
    state.language,
    state.setLanguage,
  ]);
    ...
    <>
      <div className={"font-martel bg-[#141414] h-screen dark"}>
        ...
        <div className={"w-[650px]  m-auto text-white "}>
          <div
            className={` mt-[50px] text-6xl font-bold border-b-1 border-[#333333]`}
          >
            Edit Profile
          </div>
          <div
            className={
              "flex flex-row justify-between pb-6 mt-6 border-b-1 border-[#333333]"
            }
          >
            <div className={"relative w-32 h-32"}>
              ...
              />
              <EditIcon
                className={"absolute bottom-0 left-0 cursor-pointer m-2"}
                size={20}
            ...
            <div className={"w-[500px]"}>
              ...
              <div>
                <div className={"text-[#cccccc] text-lg mt-7"}>
