...
import EpisodeCard from "@/pages/components/detail-modal/EpisodeCard";
            ...
            <div className={"border-b-2 border-[#3F3F3F] relative mb-4"}>
                {
                    videoData.episodes.slice(...currentEpisodeRange).map((episode, index) => {
                        return (
                           <EpisodeCard currentEpisode={currentEpisode} setCurrentEpisode={setCurrentEpisode} episode={episode} index={index}  key={index}/>
                        )
                    })
                }
