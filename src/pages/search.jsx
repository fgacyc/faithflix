...
export default function Search() {
    ...
    useEffect(()=>{
        ...
        fetch('https://api.enjoycoding.me/bible-bot', options).then(res=>res.json()).then(res=>{
            console.log(res)
            setAdvice(res)
        })

        fetch('https://api.enjoycoding.me/vector-query', options).then(res=>res.json()).then(res=>{
            // console.log(res)
