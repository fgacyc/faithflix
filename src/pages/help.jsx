  ...
  return (
    <div className={"font-martel bg-[#141414]"}>
      ...
      <div className={"bg-black pt-6 flex flex-col items-center"}>
        <h1 className={"text-3xl font-bold font-sans text-white text-center "}>
          Help Center
        </h1>
        <div
          className={
            "flex flex-row items-center bg-white my-8 h-11 rounded w-4/6"
          }
        >
        ...
        <div
          className={
            "bg-[#fafafa] w-full text-black px-[50px] py-6 border-b-1 border-gray-300"
          }
        >
        ...
        <div
          className={
            "bg-white w-full text-[#4c4948] px-[50px] py-4 flex flex-row justify-between"
          }
        >
        ...
        <div className={"bg-[#141414] w-full"}>
          <div
            className={`mx-[50px] border-b-1 border-gray-700 py-2
                            flex flex-row justify-start items-center `}
          >
            <div className={"text-xl text-white font-bold my-4 mr-6"}>
              Need more help?
            </div>
            <Button
              color="primary"
